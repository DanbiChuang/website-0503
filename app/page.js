        ...
        <>
            <header className="bg-black py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex justify-center items-center w-full min-h-[50vh] -mt-20 gap-4">
                        <a href="/about" className="inline-block px-6 py-3 bg-[#FF5733] text-white rounded-md transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_5px_20px_rgba(255,87,51,0.4)] hover:shadow-[0_5px_20px_rgba(147,51,234,0.3)]">
                            關於本站
                        </a>
                        <a href="/faq" className="inline-block px-6 py-3 bg-[#FF5733] text-white rounded-md transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_5px_20px_rgba(255,87,51,0.4)] hover:shadow-[0_5px_20px_rgba(147,51,234,0.3)]">
                            常見問題
                        </a>
                    </div>
                </div>
